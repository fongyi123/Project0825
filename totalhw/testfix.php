...
<?
	if(isset($_GET["number"]) and $_GET["number"] != ""){ 					//如果有傳值
...
<form action="addupdate.php" name="fm" id="fm" method="post" enctype="multipart/form-data">
...
<form action="addupdate.php" name="fm" id="fm" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
    <table width="90%" border="0" align="center">
      <tr>
        ...
        <td width="25%">
          <div class="form-group">
            <div class="col-sm-10">
              <input name="id" id="id" type="text" placeholder="員工編號" style="font-size:16px;padding:8px;width:100%" title="請輸入您的員工編號(必填)" />
            </div>
  		  </div>
        </td>
        <td align="right" width="10%">*生日(民國)</td>
        <td width="25%">
          <div class="form-group">
            <div class="col-sm-10">
              <input name="birthday" id="birthday" type="text" placeholder="EX.67-09-12" style="font-size:16px;padding:8px;width:100%" title="請選擇您的生日(民國)(必填)" />
            </div>
  		  </div>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <div class="form-group">
            <div class="col-sm-10">
              <input name="id_card" id="id_card" type="text" placeholder="身份證號" maxlength="10" style="font-size:16px;padding:8px;width:100%" title="請輸入您的身份證號(必填)" />
            </div>
  		  </div>
        </td>
        <td align="right">家裡電話</td>
        <td>
          <div class="form-group">
            <div class="col-sm-10">
              <input name="telephone" id="telephone" type="text" placeholder="06-XXXXXXX" maxlength="10" style="font-size:16px;padding:8px;width:100%" />
            </div>
  		  </div>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <div class="form-group">
            <div class="col-sm-10">
              <input name="cellphone" id="cellphone" type="text" placeholder="09XXXXXXXX" maxlength="10" style="font-size:16px;padding:8px;width:100%" />
            </div>
  		  </div>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <div class="form-group">
            <div class="col-sm-10">
              <input name="sex" id="sex" type="radio" value="男" style="width:15px; height:15px;" />男<input name="sex" id="sex" type="radio" value="女" style="width:15px; height:15px;" />女
            </div>
  		  </div>
        </td>
        <td align="right">Email</td>
        <td>
          <div class="form-group">
            <div class="col-sm-10">
              <input name="email" id="email" type="text" placeholder="Email" style="font-size:16px;padding:8px;width:100%" />
            </div>
  		  </div>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <div class="form-group">
            <div class="col-sm-10">
              <input name="wedding" id="wedding" type="radio" value="已婚" style="width:15px; height:15px;" />已婚<input name="wedding" id="wedding" type="radio" value="未婚" style="width:15px; height:15px;" />未婚
            </div>
  		  </div>
        </td>
        <td align="right">通訊住址</td>
      ...
      <tr>
        ...
        <td align="right">緊急聯絡</td>
        <td><input name="person" id="person" type="text" placeholder="緊急聯絡人" style="font-size:16px;padding:8px;width:120px" />&nbsp;<input name="connection" id="connection" type="text" placeholder="連絡電話" maxlength="10" style="font-size:16px;padding:8px;width:130px" /></td>
      </tr>
      <tr>
