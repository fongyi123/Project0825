...
//		echo $special;
	...
	if(isset($_POST["number"]) and $_POST["number"] != ""){			//如果有傳值 
...
/*	echo "<pre>";
	...
	echo "</pre>";*/
		...
		if ($db->execute($sql)){
			echo "寫入成功"; 
			header('Location: http://127.0.0.1/?folder=totalhw&file=exam');
			exit;
		} else {
			echo "寫入失敗"; 
		}
...
?>
    ...
    <form action="http://127.0.0.1/?folder=totalhw&file=exam" id="form" name="form" method="post">
    <table width="100%" border="0" align="center">
      ...
      <tr align="center">
        <td><input name="back" id="back" type="submit" value="回首頁" /></td>
      </tr>
    </table>
    </form>
